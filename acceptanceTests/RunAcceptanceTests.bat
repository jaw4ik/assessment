...
if %errorlevel% ==0 (
"%~dp0packages\NUnit.Runners.2.6.2\tools\nunit-console.exe" /include=AnswerOptions /labels /out="%~dp0TestsResults\TestResult.txt" /xml="%~dp0TestsResults\TestResult.xml" "%~dp0easygenerator.AcceptanceTests\bin\Debug\easygenerator.AcceptanceTests.dll"
