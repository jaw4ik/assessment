...
System.register('viewmodels/questions/singleSelectImage/bindingHandlers/answerImageBindingHandler.js', ['libs/knockout.js'], function (_export) {
    'use strict';

    var ko;
    return {
        setters: [function (_libsKnockoutJs) {
            ko = _libsKnockoutJs['default'];
        }],
        execute: function () {
...
System.register('models/entityClass.js', [], function (_export) {
    'use strict';
...
System.register('models/question.js', ['models/entityClass.js'], function (_export) {
    'use strict';

    var Entity, Question, __useDefault;

    return {
        setters: [function (_modelsEntityClassJs) {
            Entity = _modelsEntityClassJs.Entity;
        }],
        execute: function () {
            Question = (function (_Entity) {
                babelHelpers.inherits(Question, _Entity);

                function Question(spec) {
                    babelHelpers.classCallCheck(this, Question);

                    babelHelpers.get(Object.getPrototypeOf(Question.prototype), 'constructor', this).call(this, spec);
...
System.register('bootstrapper.tasks.js', ['bootstrapping/errorHandlingTask.js', 'bootstrapping/localizationTask.js', 'bootstrapping/routingTask.js', 'bootstrapping/compositionTask.js', 'bootstrapping/viewLocatorTask.js', 'bootstrapping/knockoutBindingsTask.js', 'bootstrapping/addWindowEventsTask.js', 'bootstrapping/trackVideoUploadTask.js'], function (_export) {
    'use strict';

    var errorHandlingTask, localizationTask, routingTask, compositionTask, viewLocatorTask, knockoutBindingsTask, addWindowEventsTask, trackVideoUploadTask;
    ...
    return {
        setters: [function (_bootstrappingErrorHandlingTaskJs) {
            errorHandlingTask = _bootstrappingErrorHandlingTaskJs['default'];
        }, function (_bootstrappingLocalizationTaskJs) {
            localizationTask = _bootstrappingLocalizationTaskJs['default'];
        }, function (_bootstrappingRoutingTaskJs) {
            routingTask = _bootstrappingRoutingTaskJs['default'];
        }, function (_bootstrappingCompositionTaskJs) {
            compositionTask = _bootstrappingCompositionTaskJs['default'];
        }, function (_bootstrappingViewLocatorTaskJs) {
            viewLocatorTask = _bootstrappingViewLocatorTaskJs['default'];
        }, function (_bootstrappingKnockoutBindingsTaskJs) {
            knockoutBindingsTask = _bootstrappingKnockoutBindingsTaskJs['default'];
        }, function (_bootstrappingAddWindowEventsTaskJs) {
            addWindowEventsTask = _bootstrappingAddWindowEventsTaskJs['default'];
        }, function (_bootstrappingTrackVideoUploadTaskJs) {
            trackVideoUploadTask = _bootstrappingTrackVideoUploadTaskJs['default'];
        }],
        execute: function () {
            _export('default', { getCollection: getCollection });
        }
    };
});
System.register('bootstrapper.js', ['libs/durandal/system.js', 'bootstrapper.tasks.js'], function (_export) {
    'use strict';
    ...
    return {
        setters: [function (_libsDurandalSystemJs) {
            system = _libsDurandalSystemJs['default'];
        }, function (_bootstrapperTasksJs) {
            tasks = _bootstrapperTasksJs['default'];
        }],
        execute: function () {}
    };
});
...
(function() {
var _removeDefine = System.get("@@amd-helpers").createDefine();
define("main.js", ["libs/durandal/system.js", "libs/durandal/app.js", "bootstrapper.js", "userContext.js", "synchronization/listener.js", "onboarding/initialization.js", "audio/index.js"], function(system, app, bootstrapper, userContext, synchronization, onboarding, audio) {
  if (!has('release')) {
    system.debug(true);
  }
...
System.register('index.js', ['libs/durandal/viewEngine.js', 'libs/durandal/system.js', 'main.js'], function (_export) {
    'use strict';

    var viewEngine, system, moduleIds, systemNormalize, systemImport, systemReduceRegister;
    return {
        setters: [function (_libsDurandalViewEngineJs) {
            viewEngine = _libsDurandalViewEngineJs['default'];
        }, function (_libsDurandalSystemJs) {
            system = _libsDurandalSystemJs['default'];
        }, function (_mainJs) {

            //System.import('main');

            for (var _key in _mainJs) {
                if (_key !== 'default') _export(_key, _mainJs[_key]);
            }
        }],
        execute: function () {
