...
{
    [TestClass]
    public class StarterAccessAttributeTests
    {
        private StarterAccessAttribute _attribute;
        ...
        {
            _attribute = new StarterAccessAttribute();
        ...
        [TestMethod]
        public void OnAuthorization_ShouldSetForbiddenResult_WhenUserDoesNotHaveStarterPlan()
        {
            //Arrange
            _filterContext.Result = null;
            _identity.IsAuthenticated.Returns(true);
        ...
        [TestMethod]
        public void OnAuthorization_ShouldNotSetResult_WhenUserHasStarterPlan()
        {
            //Arrange
            _filterContext.Result = null;
            _identity.IsAuthenticated.Returns(true);
