...
namespace easygenerator.Web.Tests.Components.ActionFilters.Authorization.Permissions
{
    ...
    public class CourseAccessAttributeTests
    {
        ...
        {
            _attribute = new CoursePermissionAttribute();
        ...
        [TestMethod]
        public void OnAuthorization_ShouldSetForbiddenResult_WhenHasNoPermissionsToCourse()
        {
            //Arrange
            _filterContext.Result = null;
            _identity.IsAuthenticated.Returns(true);
            ...
            course.IsPermittedTo(Arg.Any<string>()).Returns(false);
        ...
        [TestMethod]
        public void OnAuthorization_ShouldNotSetResult_WhenHasCoursePermissions()
        {
            //Arrange
            _filterContext.Result = null;
            _identity.IsAuthenticated.Returns(true);
            ...
            var course = Substitute.For<Course>();
            course.IsPermittedTo(Arg.Any<string>()).Returns(true);
            _courseRepository.Get(new Guid(CourseId)).Returns(course);
