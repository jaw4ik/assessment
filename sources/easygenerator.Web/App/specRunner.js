function runSpecs(env) {
    ...
    require(['bootstrapper'], function (bootstrapper) {
        ...
        var specs = [
            ...
            'synchronization/handlers/answer/eventHandlers/singleSelectAnswerCorrectnessUpdated.spec',
            ...
            'viewmodels/questions/singleSelect/singleSelectAnswers.spec',
            'viewmodels/questions/singleSelect/singleSelect.spec',
