function runSpecs(env) {
    ...
    require(['bootstrapper'], function (bootstrapper) {
        ...
        var specs = [
            ...
            'synchronization/handlers/answer/eventHandlers/multiplechoiceAnswerCorrectnessUpdated.spec',
            ...
            'viewmodels/questions/multipleChoice/multipleChoiceAnswers.spec',
