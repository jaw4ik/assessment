function runSpecs(env) {
    ...
    System.import('system-config.js').then(function () {
        ...
        System.import('bootstrapper').then(function (bootstrapper) {
            ...
            //System.amdRequire(specs, function () {
            //    debugger;
            //    env.execute();
            //});
            ...
            debugger;
            System.amdRequire(specs[0], function () {
                debugger;
            });

            //specs.reduce(function (current, next) {
            //    if (typeof current === "string") {
            //        return System.import(current).then(function (m) {
            //            console.log(m);
            //            return System.import(next).then(function(m) {
            //                console.log(m);
            //            });
            //        });
            //    } else {
            //        return current.then(function (m) {
            //            console.log(m);
            //            System.import(next).then(function(m) {
            //                console.log(m);
            //            });
            //        });
            //    }
