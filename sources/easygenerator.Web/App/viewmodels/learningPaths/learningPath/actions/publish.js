define(['knockout', 'notify', 'eventTracker', 'clientContext', 'constants', 'routing/router', 'durandal/app', 'viewmodels/learningPaths/learningPath/queries/getLearningPathByIdQuery'], function (ko, notify, eventTracker, clientContext, constants, router, app, getLearningPathByIdQuery) {
