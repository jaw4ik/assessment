define({
    ...
    templateSettings: {
        ...
        nl: 'Instellingen van de cursussjabloon:',
    ...
    introPublishCourseDesc: {
        en: 'Publish to easygenerator web-server or to your own web server.',
        nl: 'Publiceer de cursus naar de webserver van easygenerator of naar uw eigen webserver.',
        de: 'Veröffentlichen Sie ihn auf dem easygenerator-Webserver oder auf Ihrem eigenen Webserver.'
    },
    ...
    passwordRecovery: {
        ...
        de: 'Kennwortwiederherstellung'
    },
    RequestError: {
        en: 'An error was encountered while processing your request:',
        nl: 'Er is een fout opgetreden bij de verwerking van uw verzoek:',
    ...
    ForgotPassword: {
        ...
        nl: 'Wachtwoord vergeten?',
        de: 'Haben Sie Ihr Kennwort vergessen?'
    },
    ForgotPasswordSent: {
        en: 'We\'ve sent you an e-mail with instructions on how to reset your password.',
        nl: 'We hebben een e-mail verzonden met instructies voor het opnieuw instellen van uw wachtwoord.',
        de: 'Wir haben Ihnen eine E-Mail mit Anleitungen zum Rücksetzen Ihres Kenntworts gesendet.'
    },
    ...
    createCourseHelpHint: {
        ...
        nl: '<p>Een <strong>cursussjabloon</strong> bestaat uit een reeks voorgedefinieerde grafische en instructieve ontwerpparameters.</p><p>De sjabloon definieert hoe lesmateriaal aan een cursist wordt gepresenteerd, hoe een cursist hiermee kan omgaan en welke invloed de antwoorden van de cursist hebben op de cursus.</p><p>Een auteur die voor een bepaalde cursussjabloon kiest, wijzigt ook een reeks ontwerpmogelijkheden, afhankelijk van welke hiervan door de gekozen cursussjabloon worden ondersteund.</p><p><a href=\"http://help.easygenerator.com/en-us/learning/web-edition/easygenerator/user-guide\" target=\"_blank\">Meer informatie...<a></p>',
