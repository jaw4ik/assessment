...
import { Color } from './../sections/Interface';
...
export default class GeneralStyles {
    constructor() {
        ...
        this.viewUrl = 'design/tabs/fontsTabSections/generalStyles.html';
...
export class ContentElement extends Font{
    constructor(spec, defaultSpec, mainFontFamily, generalFontColor, secondaryFontColor){
        ...
        this.viewUrl = 'design/tabs/fontsTabSections/textStyle.html';
