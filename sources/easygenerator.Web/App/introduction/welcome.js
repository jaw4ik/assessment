define(['plugins/router', 'eventTracker', 'dataContext', 'httpWrapper', 'uiLocker'], function (router, eventTracker, dataContext, httpWrapper, uiLocker) {
    var
        events = {
        ...
        startEasygenerator = function () {
            if (!_.isEmptyOrWhitespace(dataContext.userEmail)) {
                uiLocker.lock();
