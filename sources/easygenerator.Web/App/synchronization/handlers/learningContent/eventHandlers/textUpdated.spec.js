define(['synchronization/handlers/learningContent/eventHandlers/textUpdated'], function (handler) {
    "use strict";
    ...
    describe('synchronization learningContent [textUpdated]', function () {
        ...
        describe('when question is found', function () {
            ...
            it('should trigger app event \'learningContent:textUpdatedByCollaborator\'', function () {
                handler(question.id, learningContent, modifiedOn);
                expect(app.trigger).toHaveBeenCalled();
                expect(app.trigger.calls.mostRecent().args[0]).toBe(constants.messages.question.learningContent.textUpdatedByCollaborator);
            });
