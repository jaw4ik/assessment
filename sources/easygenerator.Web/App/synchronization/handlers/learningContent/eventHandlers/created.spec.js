define(['synchronization/handlers/learningContent/eventHandlers/created'], function (handler) {
    "use strict";
    ...
    describe('synchronization learningContent [created]', function () {
        ...
        describe('when question is found', function () {
            ...
            it('should trigger app event \'learningContent:createdByCollaborator\'', function () {
                handler(question.id, learningContent, modifiedOn);
                expect(app.trigger).toHaveBeenCalled();
                expect(app.trigger.calls.mostRecent().args[0]).toBe(constants.messages.question.learningContent.createdByCollaborator);
            });
