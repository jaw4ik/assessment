import handler from './answerTextChanged';
import dataContext from 'dataContext';
import app from 'durandal/app';
import constants from 'constants';

describe('synchronization rankingText [answerTextChanged]', () => {
    ...
    it('should trigger app event', () => {
        ...
        expect(app.trigger.calls.mostRecent().args[0]).toBe(constants.messages.question.rankingText.answerTextChangedByCollaborator);
