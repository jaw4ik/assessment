define(['synchronization/handlers/questions/hotSpot/eventHandlers/polygonCreated'], function (handler) {
    "use strict";
    ...
    describe('synchronization hotSpot [polygonCreated]', function () {
        ...
        it('should trigger app event', function () {
            ...
            expect(app.trigger.calls.mostRecent().args[0]).toBe(constants.messages.question.hotSpot.polygonCreatedByCollaborator);
        });
    });
})