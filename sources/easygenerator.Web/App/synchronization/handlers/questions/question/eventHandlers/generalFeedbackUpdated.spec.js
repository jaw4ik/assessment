define(['synchronization/handlers/questions/question/eventHandlers/generalFeedbackUpdated'], function (handler) {
    "use strict";
    ...
    describe('synchronization question [generalFeedbackUpdated]', function () {
        ...
        it('should trigger app event', function () {
            spyOn(dataContext, 'getQuestions').and.returnValue([question]);
            handler(questionId, feedbackText, modifiedOn.toISOString());
            expect(app.trigger).toHaveBeenCalledWith(constants.messages.question.generalFeedbackUpdatedByCollaborator, question, feedbackText);
        });
    });
});