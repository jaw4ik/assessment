define(['synchronization/handlers/questions/question/eventHandlers/backgroundChanged'], function (handler) {
    "use strict";
    ...
    describe('synchronization question [backgroundChanged]', function () {
        ...
        it('should trigger app event', function () {
            spyOn(dataContext, 'getQuestions').and.returnValue([question]);
            handler(questionId, background, modifiedOn.toISOString());
            expect(app.trigger).toHaveBeenCalledWith(constants.messages.question.backgroundChangedByCollaborator, question);
        });
    });
})