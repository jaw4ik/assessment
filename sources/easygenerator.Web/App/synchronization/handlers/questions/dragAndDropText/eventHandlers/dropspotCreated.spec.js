define(['synchronization/handlers/questions/dragAndDropText/eventHandlers/dropspotCreated'], function (handler) {
    "use strict";
    ...
    describe('synchronization dragAndDropText [dropspotCreated]', function () {
        ...
        it('should trigger app event', function () {
            ...
            expect(app.trigger.calls.mostRecent().args[0]).toBe(constants.messages.question.dragAndDropText.dropspotCreatedByCollaborator);
        });
    });
})