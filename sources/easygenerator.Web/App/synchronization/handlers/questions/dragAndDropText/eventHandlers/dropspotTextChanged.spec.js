define(['synchronization/handlers/questions/dragAndDropText/eventHandlers/dropspotTextChanged'], function (handler) {
    "use strict";
    ...
    describe('synchronization dragAndDropText [dropspotTextChanged]', function () {
        ...
        it('should trigger app event', function () {
            ...
            expect(app.trigger.calls.mostRecent().args[0]).toBe(constants.messages.question.dragAndDropText.dropspotTextChangedByCollaborator);
        });
    });
})