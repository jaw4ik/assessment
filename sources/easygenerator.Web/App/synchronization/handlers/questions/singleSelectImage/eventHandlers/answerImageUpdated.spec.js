define(['synchronization/handlers/questions/singleSelectImage/eventHandlers/answerImageUpdated'], function (handler) {
    "use strict";
    ...
    var
        ...
        mapper = require('mappers/singleSelectImageAnswerMapper')
    ;

    describe('synchronization singleSelectImage [answerImageUpdated]', function () {
        ...
        it('should trigger app event', function () {
            spyOn(dataContext, 'getQuestions').and.returnValue([question]);
            handler(questionId, answer, modifiedOn.toISOString());
            expect(app.trigger).toHaveBeenCalledWith(constants.messages.question.singleSelectImage.answerImageUpdatedByCollaborator, questionId, answerModel);
        });
    });
})