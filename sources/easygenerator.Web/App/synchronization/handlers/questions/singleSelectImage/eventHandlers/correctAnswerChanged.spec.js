define(['synchronization/handlers/questions/singleSelectImage/eventHandlers/correctAnswerChanged'], function (handler) {
    "use strict";
    ...
    describe('synchronization singleSelectImage [correctAnswerChanged]', function () {
        ...
        it('should trigger app event', function () {
            spyOn(dataContext, 'getQuestions').and.returnValue([question]);
            handler(questionId, answerId, modifiedOn.toISOString());
            expect(app.trigger).toHaveBeenCalledWith(constants.messages.question.singleSelectImage.correctAnswerChangedByCollaborator, questionId, answerId);
        });
    });
})