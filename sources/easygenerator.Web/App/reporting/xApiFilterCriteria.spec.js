define(['reporting/xApiFilterCriteria'], function (FilterCriteria) {
    "use strict";

    var constants = require('constants');

    describe('model [FilterCriteria]', function () {

        it('should be constructor function', function () {
            expect(FilterCriteria).toBeFunction();
        });
        ...
        describe('constructor:', function () {
            ...
            describe('when spec contains courseId', function () {
                it('should fill instance with courseId', function () {
                    ...
                    var criteria = new FilterCriteria(spec);
