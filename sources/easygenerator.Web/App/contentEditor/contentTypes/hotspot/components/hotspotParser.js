define(['constants'], function (constants) {
    'use strict';
    var templates = {
            hotspotWrapper: '<span data-type="' + constants.contentsTypes.hotspotOnImage + '" class="hotspotOnImage" style="position: relative;display: inline-block;max-width: 100%"><img src="{url}" alt="" style="max-width:100%" /></span>',
