        ...
        describe('repository [helpHintRepository]', function () {
            ...
            describe('getHint:', function () {
                ...
                it('should be function', function () {
                    expect(repository.getHint).toBeFunction();
                });

                it('shoud return promise', function () {
                    expect(repository.getHint()).toBePromise();
                });

                describe('when hint does not exist in dataContext', function () {

                    it('should resolve promise with null', function () {
                        dataContext.helpHints = [];
                        var promise = repository.getHint();
                ...
                it('should resolve promise with hint', function () {
                    var hint = { id: 'id', name: 'name' };
                    dataContext.helpHints = [hint];
                    var promise = repository.getHint(hint.name);

                    waitsFor(function () {
                        return !promise.isPending();
                    });
                    runs(function () {
                        expect(promise).toBeResolvedWith(hint);
                    });
                });
