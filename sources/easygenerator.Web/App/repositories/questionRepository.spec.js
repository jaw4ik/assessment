define(['repositories/questionRepository'],
    function (questionRepository) {
        ...
        describe('[questionRepository]', function () {
                        ...
                        describe('and response is an object', function () {
                            ...
                            describe('and response has modification date', function () {
                                ...
                                var response = {
                                    ...
                                    GeneralFeedbackText: 'feedback text',
            ...
            describe('updateGeneralFeedback:', function () {

                it('should be function', function () {
                    expect(questionRepository.updateGeneralFeedback).toBeFunction();
                });

                it('should return promise', function () {
                    expect(questionRepository.updateGeneralFeedback()).toBePromise();
                });
                ...
                describe('when question id is undefined', function () {
                    ...
                    it('should reject promise', function (done) {
                        var promise = questionRepository.updateGeneralFeedback(undefined, feedbackText);
                        promise.fin(function () {
                            expect(promise).toBeRejectedWith('Question id is not a string');
                            done();
                        });
                ...
                describe('when question id is not a string', function () {
                    ...
                    it('should reject promise', function (done) {
                        var promise = questionRepository.updateGeneralFeedback({}, feedbackText);
                        promise.fin(function () {
                            expect(promise).toBeRejectedWith('Question id is not a string');
                            done();
                        });
                ...
                describe('when all arguments are valid', function () {
                    ...
                    it('should send request to server to api/question/updateGeneralFeedback', function (done) {
                        post.reject();

                        var promise = questionRepository.updateGeneralFeedback(questionId, feedbackText);
                        promise.fin(function () {
                            expect(httpWrapper.post).toHaveBeenCalledWith('api/question/updateGeneralFeedback', {
                                questionId: questionId,
                                feedbackText: feedbackText
                            });
                            done();
