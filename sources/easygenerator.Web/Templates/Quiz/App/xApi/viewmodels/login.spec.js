define(['./login', 'xApi/xApiInitializer', 'context', 'plugins/router', 'repositories/courseRepository', 'xApi/errorsHandler'],
    function (viewModel, xApiInitializer, context, router, repository, errorsHandler) {
