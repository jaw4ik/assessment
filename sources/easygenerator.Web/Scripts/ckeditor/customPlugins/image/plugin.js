...
(function () {
    ...
    CKEDITOR.plugins.image = {
        requires: 'dialog',
        lang: 'en,uk,zh-cn,pt-br,de,nl,es,it', // %REMOVE_LINE_CORE%
    ...
    CKEDITOR.plugins.add('image', CKEDITOR.plugins.image);

    CKEDITOR.document.appendStyleSheet(CKEDITOR.plugins.image.path + 'styles.css');
