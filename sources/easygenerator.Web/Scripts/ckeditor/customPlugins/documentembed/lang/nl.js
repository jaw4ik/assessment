CKEDITOR.plugins.setLang('documentembed', 'nl', {
    ebmedDocument: 'Embed documents [nl]',
    ...
    googleDocumentsTitle: 'You can embed your documents using Google Docs service. It\'s free! [nl]',
    slideshare: 'Slideshare [nl]',
    slideshareTitle: 'You can embed your presentations using SlideShare service. It\'s free! [nl]',
    other: 'Other [nl]',
    otherTitle: 'You can embed your documents from any other services that support "embedding". [nl]',
    ...
    slideshareExplanation: '<ol>' +
                        '<li>Visit <a href="http://www.slideshare.net/">SlideShare website</a> and Sign up. [nl]</li>' +
                        '<li>Upload your presentation to SlideShare. [nl]</li>' +
                        '<li>Open your presentation and click the "Share" button below the player. [nl]</li>' +
