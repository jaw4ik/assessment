...
namespace easygenerator.Web.BuildCourse
{
    public class BuildPathProvider
    {
        ...
        public virtual string GetGeneralFeedbackContentFileName(string buildDirectory, string objectiveId, string questionId)
        {
            return Path.Combine(GetQuestionDirectoryName(buildDirectory, objectiveId, questionId), "generalFeedback" + ".html");
        }
